...
.method public static getBoostModeValue(Landroid/content/Context;Ljava/lang/String;I)I
    ...
    iget v9, v1, Landroid/graphics/Point;->x:I
    :try_end_c6
    .catch Landroid/os/RemoteException; {:try_start_a8 .. :try_end_c6} :catch_d0

    const/16 v10, 0x438

    if-gt v9, v10, :cond_cd
...
.method public static isGameLauncherEnabled(Landroid/content/Context;)Z
    ...
    :try_end_1a
    .catch Ljava/lang/IllegalArgumentException; {:try_start_14 .. :try_end_1a} :catch_21
...
.method private static sendSAlogging(Landroid/content/Context;I)V
    ...
    :try_end_11d
    .catch Ljava/lang/IllegalArgumentException; {:try_start_10f .. :try_end_11d} :catch_202

    :goto_11d
    return-void

    :cond_11e
    if-ne v4, v9, :cond_125
...
.method public static setGameLancherEnabled(Landroid/content/Context;Z)V
    ...
    :try_end_1c
    .catch Ljava/lang/IllegalArgumentException; {:try_start_2 .. :try_end_1c} :catch_21
...
.method public static setPerformanceBoosterMode(Landroid/content/Context;IZ)V
    ...
    :try_end_d7
    .catch Landroid/os/RemoteException; {:try_start_cf .. :try_end_d7} :catch_d9
