...
.method private checkVersion(Lorg/json/JSONObject;)Z
    ...
    invoke-virtual {p1, v4}, Lorg/json/JSONObject;->getInt(Ljava/lang/String;)I
    :try_end_55
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_55} :catch_59
...
.method private isNeedUpdate(Lorg/json/JSONObject;)Z
    ...
    :try_end_5a
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_5a} :catch_5e
...
.method private isProductShipBinary()Z
    ...
    :try_end_45
    .catch Ljava/lang/IllegalArgumentException; {:try_start_1 .. :try_end_45} :catch_55
...
.method private setLatestEULA(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V
    :try_end_3f
    .catch Ljava/lang/Exception; {:try_start_10 .. :try_end_3f} :catch_57
    ...
    :try_end_56
    .catch Ljava/lang/Exception; {:try_start_51 .. :try_end_56} :catch_68
...
.method public final getEulaFromHtml(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_23
    .catch Ljava/net/SocketTimeoutException; {:try_start_3 .. :try_end_23} :catch_a0
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_23} :catch_6a
    .catchall {:try_start_3 .. :try_end_23} :catchall_8c
    ...
    :try_end_3b
    .catch Ljava/net/SocketTimeoutException; {:try_start_23 .. :try_end_3b} :catch_3c
    .catch Ljava/lang/Exception; {:try_start_23 .. :try_end_3b} :catch_a2
    .catchall {:try_start_23 .. :try_end_3b} :catchall_9d
    ...
    invoke-virtual {v9}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;
    :try_end_58
    .catch Ljava/net/SocketTimeoutException; {:try_start_55 .. :try_end_58} :catch_3c
    .catch Ljava/lang/Exception; {:try_start_55 .. :try_end_58} :catch_a2
    .catchall {:try_start_55 .. :try_end_58} :catchall_9d
    ...
    :try_end_77
    .catchall {:try_start_6b .. :try_end_77} :catchall_8c
