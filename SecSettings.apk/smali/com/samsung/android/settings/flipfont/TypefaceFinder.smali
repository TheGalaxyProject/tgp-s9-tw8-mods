...
.method private findTypefacesWithCR(Ljava/lang/String;)Z
    ...
    :try_end_7
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_7} :catch_46
    ...
    :try_end_3f
    .catch Ljava/lang/Exception; {:try_start_2b .. :try_end_3f} :catch_48
    ...
    :try_end_7f
    .catch Ljava/lang/Exception; {:try_start_73 .. :try_end_7f} :catch_84
...
.method public findTypefaces(Landroid/content/res/AssetManager;Ljava/lang/String;)Z
    ...
    :try_end_8
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_8} :catch_11
    ...
    invoke-virtual {v2}, Ljava/io/InputStream;->close()V
    :try_end_39
    .catch Ljava/lang/Exception; {:try_start_17 .. :try_end_39} :catch_3c
...
.method public getSansEntries(Landroid/content/pm/PackageManager;Ljava/util/Vector;Ljava/util/Vector;Ljava/util/Vector;)V
    ...
    invoke-virtual {v0, v1, v2}, Ljava/util/Vector;->add(ILjava/lang/Object;)V
    :try_end_1f2
    .catch Ljava/lang/Exception; {:try_start_bb .. :try_end_1f2} :catch_1f4
    ...
    invoke-virtual {v0, v1}, Ljava/util/Vector;->add(Ljava/lang/Object;)Z
    :try_end_2c0
    .catch Ljava/lang/Exception; {:try_start_21d .. :try_end_2c0} :catch_1f4
