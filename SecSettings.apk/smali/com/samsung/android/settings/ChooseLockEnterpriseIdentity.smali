...
.method private handleAuthFail(I)V
    ...
    :try_end_42
    .catch Ljava/lang/SecurityException; {:try_start_2b .. :try_end_42} :catch_c3

    move-result v5

    :cond_43
    :goto_43
    if-lt v4, v12, :cond_a1

    if-gtz v5, :cond_e0

    if-ne v4, v12, :cond_e0
    ...
    :try_end_c2
    .catch Ljava/lang/SecurityException; {:try_start_b9 .. :try_end_c2} :catch_c3
...
.method private validatePassword(Ljava/lang/String;)Ljava/lang/String;
    ...
    if-lt v0, v8, :cond_103

    const/16 v8, 0x7f

    if-le v0, v8, :cond_10b
    ...
    if-lt v0, v8, :cond_127

    const/16 v8, 0x5a

    if-gt v0, v8, :cond_127
    ...
    if-lt v0, v8, :cond_134

    const/16 v8, 0x7a

    if-gt v0, v8, :cond_134
