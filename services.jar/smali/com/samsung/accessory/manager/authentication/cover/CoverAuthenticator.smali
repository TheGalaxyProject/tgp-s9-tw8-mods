...
.method private handleAuthResponse(Landroid/os/Message;)V
    ...
    if-eq v10, v4, :cond_21d

    const/16 v4, 0x1e

    if-ne v10, v4, :cond_227
    ...
    if-eq v10, v4, :cond_293

    const/16 v4, 0x15

    if-ne v10, v4, :cond_2b1

    :cond_293
    :goto_293
    const/16 v4, 0x16

    if-eq v10, v4, :cond_29b

    const/16 v4, 0xa

    if-ne v10, v4, :cond_2f2
