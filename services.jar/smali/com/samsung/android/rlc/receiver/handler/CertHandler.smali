...
.method public encryptData(Landroid/content/Context;Lcom/samsung/android/rlc/vo/DeviceApiRequestVO;)Lcom/samsung/android/rlc/vo/DeviceApiRequestVO;
    ...
    :try_end_50
    .catch Ljava/lang/Exception; {:try_start_8 .. :try_end_50} :catch_216
    ...
    invoke-static {v0, v1, v2}, Lcom/samsung/android/rlc/util/PreferencesUtil;->setString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_b7
    .catch Ljava/lang/Exception; {:try_start_53 .. :try_end_b7} :catch_1cd
    ...
    new-array v10, v0, [B
    :try_end_120
    .catch Ljava/lang/Exception; {:try_start_b7 .. :try_end_120} :catch_216
    ...
    :try_end_133
    .catch Lcom/samsung/android/service/RemoteLockControl/RemoteLockControlException; {:try_start_120 .. :try_end_133} :catch_298
    .catch Ljava/lang/Exception; {:try_start_120 .. :try_end_133} :catch_216
    ...
    :try_end_173
    .catch Ljava/lang/Exception; {:try_start_136 .. :try_end_173} :catch_216
    ...
    invoke-virtual {v0, v1, v4}, Lcom/samsung/android/rlc/util/RLCUtil;->encryptData([B[B)[B
    :try_end_190
    .catch Ljava/lang/Exception; {:try_start_173 .. :try_end_190} :catch_2f3
    ...
    invoke-virtual {v0, v10}, Lcom/samsung/android/rlc/vo/DeviceApiRequestVO;->setDataByte([B)V
    :try_end_196
    .catch Ljava/lang/Exception; {:try_start_191 .. :try_end_196} :catch_216
    ...
    invoke-static {v0, v1, v2}, Lcom/samsung/android/rlc/util/PreferencesUtil;->setString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1cb
    .catch Ljava/lang/Exception; {:try_start_197 .. :try_end_1cb} :catch_1cd
    ...
    invoke-static {v0, v1, v2}, Lcom/samsung/android/rlc/util/PreferencesUtil;->setString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_214
    .catch Ljava/lang/Exception; {:try_start_1ce .. :try_end_214} :catch_216
    ...
    invoke-static {v0, v1, v2}, Lcom/samsung/android/rlc/util/PreferencesUtil;->setString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_266
    .catch Ljava/lang/Exception; {:try_start_242 .. :try_end_266} :catch_1cd
    ...
    invoke-static {v0, v1, v2}, Lcom/samsung/android/rlc/util/PreferencesUtil;->setRetryBackoff(Landroid/content/Context;Ljava/lang/String;I)V
    :try_end_2e6
    .catch Ljava/lang/Exception; {:try_start_268 .. :try_end_2e6} :catch_216
    ...
    invoke-static/range {v21 .. v22}, Lcom/samsung/android/rlc/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2f0
    .catch Ljava/lang/Exception; {:try_start_2e8 .. :try_end_2f0} :catch_2f3
    ...
    invoke-static/range {v21 .. v22}, Lcom/samsung/android/rlc/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_341
    .catch Ljava/lang/Exception; {:try_start_2f4 .. :try_end_341} :catch_216
