...
.method private static getResponseMsg(Ljava/io/InputStream;)Ljava/lang/String;
    ...
    :try_end_14
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_7 .. :try_end_14} :catch_112
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_14} :catch_7c
    .catchall {:try_start_7 .. :try_end_14} :catchall_e4
    ...
    :try_end_22
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_14 .. :try_end_22} :catch_23
    .catch Ljava/io/IOException; {:try_start_14 .. :try_end_22} :catch_115
    .catchall {:try_start_14 .. :try_end_22} :catchall_10f
    ...
    :try_end_42
    .catchall {:try_start_25 .. :try_end_42} :catchall_e4
    ...
    :try_end_4c
    .catch Ljava/io/IOException; {:try_start_44 .. :try_end_4c} :catch_c4
    ...
    invoke-virtual {p0}, Ljava/io/InputStream;->close()V
    :try_end_5b
    .catch Ljava/io/IOException; {:try_start_53 .. :try_end_5b} :catch_5d
    ...
    invoke-static {v6, v7}, Lcom/samsung/android/rlc/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_9a
    .catchall {:try_start_7d .. :try_end_9a} :catchall_e4
...
.method public static httpRequest(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/samsung/android/rlc/receiver/handler/HttpRequestHandler$RESPONSE;
    ...
    :try_end_69
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_8 .. :try_end_69} :catch_b7
    .catch Lorg/apache/http/client/ClientProtocolException; {:try_start_8 .. :try_end_69} :catch_98
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_69} :catch_79
    ...
    :try_end_77
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_69 .. :try_end_77} :catch_d6
    .catch Lorg/apache/http/client/ClientProtocolException; {:try_start_69 .. :try_end_77} :catch_d9
...
.method private static setSocketFactory()V
    ...
    :try_end_a4
    .catch Ljava/lang/Exception; {:try_start_41 .. :try_end_a4} :catch_3c
