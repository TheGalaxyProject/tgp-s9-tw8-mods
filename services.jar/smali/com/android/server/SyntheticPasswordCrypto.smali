...
.method public static varargs createBlob(Ljava/lang/String;[B[BJ[[B)[B
    ...
    invoke-static {v11, v8, v0}, Lcom/android/server/SyntheticPasswordCrypto;->encrypt(Ljavax/crypto/SecretKey;[B[[B)[B
    :try_end_a5
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_a5} :catch_a7
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_a5} :catch_a7
    .catch Ljavax/crypto/BadPaddingException; {:try_start_0 .. :try_end_a5} :catch_a7
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_0 .. :try_end_a5} :catch_a7
    .catch Ljava/security/KeyStoreException; {:try_start_0 .. :try_end_a5} :catch_a7
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_0 .. :try_end_a5} :catch_a7
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_a5} :catch_a7
    .catch Ljava/security/InvalidKeyException; {:try_start_0 .. :try_end_a5} :catch_a7
...
.method public static varargs decrypt([B[B[B[[B)[B
    ...
    :try_end_1b
    .catch Ljava/security/InvalidKeyException; {:try_start_18 .. :try_end_1b} :catch_1d
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_18 .. :try_end_1b} :catch_1d
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_18 .. :try_end_1b} :catch_1d
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_18 .. :try_end_1b} :catch_1d
    .catch Ljavax/crypto/BadPaddingException; {:try_start_18 .. :try_end_1b} :catch_1d
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_18 .. :try_end_1b} :catch_1d
...
.method public static varargs decryptBlob(Ljava/lang/String;[B[B[[B)[B
    ...
    :try_end_3e
    .catch Ljava/security/cert/CertificateException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljavax/crypto/BadPaddingException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljava/security/KeyStoreException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljava/security/InvalidKeyException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_0 .. :try_end_3e} :catch_40
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_0 .. :try_end_3e} :catch_40
...
.method protected static varargs personalisedHash([B[[B)[B
    ...
    throw v4
    :try_end_17
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_4 .. :try_end_17} :catch_17
    ...
    :try_end_39
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_23 .. :try_end_39} :catch_17
