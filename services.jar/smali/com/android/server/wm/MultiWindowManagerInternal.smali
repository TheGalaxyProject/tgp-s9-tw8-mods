...
.method adjustBoundsForNaviBarForConfigChange(ILandroid/graphics/Rect;ILandroid/graphics/Rect;)V
    ...
    if-eq p1, v10, :cond_3f

    const/4 v10, 0x1

    if-ne p1, v10, :cond_b5
...
.method public getLaunchBoundsForMetaKeyEvent(Landroid/view/WindowManagerPolicy$WindowState;I)Landroid/graphics/Rect;
    ...
    :try_end_2c
    .catchall {:try_start_d .. :try_end_2c} :catchall_3c
...
.method public getSpecificTargetDockedBounds(ILandroid/graphics/Rect;)V
    ...
    :try_end_57
    .catchall {:try_start_9 .. :try_end_57} :catchall_88
    ...
    :try_end_83
    .catchall {:try_start_67 .. :try_end_83} :catchall_88
...
.method public resizeTaskWithRelaunchAnim(Lcom/android/server/wm/AppWindowToken;Landroid/graphics/Rect;)V
    ...
    monitor-enter v6
    :try_end_57
    .catch Landroid/os/RemoteException; {:try_start_9 .. :try_end_57} :catch_76
    .catchall {:try_start_9 .. :try_end_57} :catchall_ae
    ...
    :try_end_6f
    .catchall {:try_start_57 .. :try_end_6f} :catchall_70
    ...
    :try_end_7a
    .catchall {:try_start_77 .. :try_end_7a} :catchall_ae
    ...
    monitor-enter v6
    :try_end_96
    .catch Landroid/os/RemoteException; {:try_start_82 .. :try_end_96} :catch_76
    .catchall {:try_start_82 .. :try_end_96} :catchall_ae
    ...
    :try_end_9e
    .catchall {:try_start_96 .. :try_end_9e} :catchall_a8
    ...
    invoke-static {}, Lcom/android/server/wm/WindowManagerService;->resetPriorityAfterLockedSection()V
    :try_end_a2
    .catch Landroid/os/RemoteException; {:try_start_9e .. :try_end_a2} :catch_76
    .catchall {:try_start_9e .. :try_end_a2} :catchall_ae
    ...
    throw v5
    :try_end_ae
    .catch Landroid/os/RemoteException; {:try_start_a9 .. :try_end_ae} :catch_76
    .catchall {:try_start_a9 .. :try_end_ae} :catchall_ae
...
.method public setCurrentInputMethodClient(Landroid/os/IBinder;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/MultiWindowManagerInternal;->mCurrentInputMethodClient:Lcom/android/server/wm/WindowState;
    :try_end_2a
    .catchall {:try_start_5 .. :try_end_2a} :catchall_37
