...
.method dumpInternal(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :try_end_6c
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_5d .. :try_end_6c} :catch_1de
    ...
    invoke-virtual {v0, v3}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V
    :try_end_1b4
    .catchall {:try_start_80 .. :try_end_1b4} :catchall_1db
    ...
    :try_end_1c8
    .catch Landroid/os/RemoteException; {:try_start_1b5 .. :try_end_1c8} :catch_4a0
    .catchall {:try_start_1b5 .. :try_end_1c8} :catchall_1db
    ...
    invoke-virtual {v0, v3}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V
    :try_end_1d9
    .catchall {:try_start_1cc .. :try_end_1d9} :catchall_1db
    ...
    if-eq v12, v3, :cond_2a9

    invoke-static/range {v24 .. v24}, Landroid/os/UserHandle;->getAppId(I)I

    move-result v3

    if-ne v12, v3, :cond_2bd
    ...
    invoke-virtual {v0, v3}, Ljava/io/PrintWriter;->println(I)V
    :try_end_49b
    .catchall {:try_start_1ff .. :try_end_49b} :catchall_1db
...
.method executeRunCommand(Ljava/lang/String;IIZ)I
    ...
    monitor-enter v5
    :try_end_17
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_17} :catch_42
    ...
    monitor-exit v5
    :try_end_22
    .catch Landroid/os/RemoteException; {:try_start_21 .. :try_end_22} :catch_42
    ...
    iput v3, v1, Lcom/android/server/job/controllers/JobStatus;->overrideState:I
    :try_end_31
    .catchall {:try_start_26 .. :try_end_31} :catchall_3f
    ...
    monitor-exit v5
    :try_end_34
    .catch Landroid/os/RemoteException; {:try_start_33 .. :try_end_34} :catch_42
    ...
    throw v3
    :try_end_42
    .catch Landroid/os/RemoteException; {:try_start_3d .. :try_end_42} :catch_42
...
.method getJobState(Ljava/io/PrintWriter;Ljava/lang/String;II)I
    ...
    monitor-enter v7
    :try_end_26
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_26} :catch_f3
    ...
    invoke-virtual {p1, v5}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V
    :try_end_46
    .catchall {:try_start_26 .. :try_end_46} :catchall_f0
    ...
    monitor-exit v7
    :try_end_49
    .catch Landroid/os/RemoteException; {:try_start_48 .. :try_end_49} :catch_f3
    ...
    invoke-virtual {p1, v5}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V
    :try_end_a5
    .catchall {:try_start_4b .. :try_end_a5} :catchall_f0
    ...
    :try_end_b7
    .catch Landroid/os/RemoteException; {:try_start_a6 .. :try_end_b7} :catch_f5
    .catchall {:try_start_a6 .. :try_end_b7} :catchall_f0
    ...
    throw v5
    :try_end_f3
    .catch Landroid/os/RemoteException; {:try_start_ec .. :try_end_f3} :catch_f3
...
.method public onBootPhase(I)V
    ...
    :try_end_71
    .catch Landroid/os/RemoteException; {:try_start_65 .. :try_end_71} :catch_cd
    ...
    :try_end_c8
    .catchall {:try_start_7d .. :try_end_c8} :catchall_ca
...
.method public onDeviceIdleStateChanged(Z)V
    ...
    :try_end_4d
    .catchall {:try_start_6 .. :try_end_4d} :catchall_4f
...
.method public onJobCompletedLocked(Lcom/android/server/job/controllers/JobStatus;Z)V
    ...
    :try_end_2c
    .catch Ljava/lang/SecurityException; {:try_start_25 .. :try_end_2c} :catch_43
    ...
    :try_end_74
    .catch Ljava/lang/SecurityException; {:try_start_6d .. :try_end_74} :catch_78
...
.method public scheduleAsPackage(Landroid/app/job/JobInfo;Landroid/app/job/JobWorkItem;ILjava/lang/String;ILjava/lang/String;)I
    ...
    :try_end_68
    .catchall {:try_start_49 .. :try_end_68} :catchall_9d
    ...
    throw v3
    :try_end_9d
    .catchall {:try_start_6a .. :try_end_9d} :catchall_9d
    ...
    invoke-direct {p0}, Lcom/android/server/job/JobSchedulerService;->maybeRunPendingJobsLocked()V
    :try_end_d0
    .catchall {:try_start_a0 .. :try_end_d0} :catchall_9d
