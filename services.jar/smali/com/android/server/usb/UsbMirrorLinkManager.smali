...
.method private getStringIdFromMirrorLinkPackage(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    :try_end_54
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_4 .. :try_end_54} :catch_55
...
.method private isEmergencyMode(Landroid/content/Context;)Z
    ...
    :try_end_c
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_2 .. :try_end_c} :catch_12
...
.method private isTalkBackEnabled(Landroid/content/Context;)Z
    ...
    invoke-virtual {v14}, Ljava/lang/Boolean;->booleanValue()Z
    :try_end_6c
    .catch Ljava/lang/NullPointerException; {:try_start_c .. :try_end_6c} :catch_8a
    .catch Ljava/lang/NoSuchMethodException; {:try_start_c .. :try_end_6c} :catch_85
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_c .. :try_end_6c} :catch_80
    .catch Ljava/lang/IllegalAccessException; {:try_start_c .. :try_end_6c} :catch_7b
    .catch Ljava/lang/IllegalArgumentException; {:try_start_c .. :try_end_6c} :catch_76
    .catch Ljava/lang/NoSuchFieldException; {:try_start_c .. :try_end_6c} :catch_71
...
.method private onBootComplete()V
    ...
    :try_end_1e
    .catch Ljava/io/FileNotFoundException; {:try_start_19 .. :try_end_1e} :catch_cd
    .catch Ljava/io/IOException; {:try_start_19 .. :try_end_1e} :catch_9a
    ...
    :try_end_29
    .catch Ljava/io/FileNotFoundException; {:try_start_1e .. :try_end_29} :catch_2a
    .catch Ljava/io/IOException; {:try_start_1e .. :try_end_29} :catch_d0
    ...
    :try_end_96
    .catch Ljava/io/IOException; {:try_start_93 .. :try_end_96} :catch_c8
