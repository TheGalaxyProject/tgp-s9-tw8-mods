...
.method private dispatchOnTrustChanged(ZII)V
    ...
    :try_end_56
    .catch Landroid/os/DeadObjectException; {:try_start_4b .. :try_end_56} :catch_64
    .catch Landroid/os/RemoteException; {:try_start_4b .. :try_end_56} :catch_59
...
.method private dispatchOnTrustManagedChanged(ZI)V
    ...
    :try_end_44
    .catch Landroid/os/DeadObjectException; {:try_start_39 .. :try_end_44} :catch_52
    .catch Landroid/os/RemoteException; {:try_start_39 .. :try_end_44} :catch_47
...
.method private getSettingsAttrs(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Lcom/android/server/trust/TrustManagerService$SettingsAttrs;
    ...
    :try_end_2e
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_16 .. :try_end_2e} :catch_b9
    .catch Ljava/io/IOException; {:try_start_16 .. :try_end_2e} :catch_b1
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_16 .. :try_end_2e} :catch_a9
    .catchall {:try_start_16 .. :try_end_2e} :catchall_c1
    ...
    invoke-static {v13, v14}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_65
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_35 .. :try_end_65} :catch_b9
    .catch Ljava/io/IOException; {:try_start_35 .. :try_end_65} :catch_b1
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_35 .. :try_end_65} :catch_a9
    .catchall {:try_start_35 .. :try_end_65} :catchall_c1
    ...
    :try_end_80
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_6c .. :try_end_80} :catch_b9
    .catch Ljava/io/IOException; {:try_start_6c .. :try_end_80} :catch_b1
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_6c .. :try_end_80} :catch_a9
...
.method private refreshDeviceLockedForUser(I)V
    ...
    :try_end_91
    .catch Landroid/os/RemoteException; {:try_start_8e .. :try_end_91} :catch_a2
