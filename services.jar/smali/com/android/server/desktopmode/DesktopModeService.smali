...
.method static synthetic -get10(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/am/MultiWindowManagerService;
    .registers 2
...
.method static synthetic -get11(Lcom/android/server/desktopmode/DesktopModeService;)Ljava/util/Map;
    .registers 2
...
.method static synthetic -get12(Lcom/android/server/desktopmode/DesktopModeService;)Landroid/content/ContentResolver;
    .registers 2
...
.method static synthetic -get18(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/desktopmode/UiManager;
    .registers 2
...
.method static synthetic -get9(Lcom/android/server/desktopmode/DesktopModeService;)Lcom/android/server/am/MultiScreenManagerService;
    .registers 2

    iget-object v0, p0, Lcom/android/server/desktopmode/DesktopModeService;->mMultiScreenManager:Lcom/android/server/am/MultiScreenManagerService;
...
.method private onBootPhase(I)V
    ...
    const-string/jumbo v1, "MultiScreen"

    invoke-static {v1}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v1

    check-cast v1, Lcom/android/server/am/MultiScreenManagerService;

    iput-object v1, p0, Lcom/android/server/desktopmode/DesktopModeService;->mMultiScreenManager:Lcom/android/server/am/MultiScreenManagerService;

    iget-object v1, p0, Lcom/android/server/desktopmode/DesktopModeService;->mSettingsHelper:Lcom/android/server/desktopmode/SettingsHelper;

    iget-object v2, p0, Lcom/android/server/desktopmode/DesktopModeService;->mTouchKeypadSettingChangedListener:Lcom/android/server/desktopmode/SettingsHelper$OnSettingChangedListener;
...
.method private setComponentFromList(II)V
    ...
    :try_end_54
    .catch Landroid/os/RemoteException; {:try_start_32 .. :try_end_54} :catch_55
    ...
    :try_end_6e
    .catch Landroid/os/RemoteException; {:try_start_5f .. :try_end_6e} :catch_55
...
.method public isAllowed(ZZ)Z
    ...
    :try_end_5f
    .catch Landroid/os/RemoteException; {:try_start_54 .. :try_end_5f} :catch_61
