...
.method private getLogFileName(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_14
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_5 .. :try_end_14} :catch_16
...
.method private installLog(Ljava/io/File;Lorg/json/JSONObject;)V
    ...
    :try_end_11
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_11} :catch_4d
    ...
    :try_end_1e
    .catch Ljava/lang/Throwable; {:try_start_12 .. :try_end_1e} :catch_59
    .catchall {:try_start_12 .. :try_end_1e} :catchall_9a
    ...
    invoke-direct {p0, v4, v5, v7}, Lcom/android/server/updates/CertificateTransparencyLogInstallReceiver;->writeLogEntry(Ljava/io/OutputStreamWriter;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_45
    .catch Ljava/lang/Throwable; {:try_start_1e .. :try_end_45} :catch_9f
    .catchall {:try_start_1e .. :try_end_45} :catchall_9c
    ...
    :try_end_4a
    .catch Ljava/lang/Throwable; {:try_start_47 .. :try_end_4a} :catch_57
    .catch Lorg/json/JSONException; {:try_start_47 .. :try_end_4a} :catch_4d
    ...
    throw v6
    :try_end_4d
    .catch Lorg/json/JSONException; {:try_start_4c .. :try_end_4d} :catch_4d
    ...
    .catch Lorg/json/JSONException; {:try_start_61 .. :try_end_64} :catch_4d
    ...
    throw v5
    :try_end_99
    .catch Lorg/json/JSONException; {:try_start_66 .. :try_end_99} :catch_4d
...
.method protected install([BI)V
    ...
    throw v12
    :try_end_e8
    .catch Ljava/io/IOException; {:try_start_c1 .. :try_end_e8} :catch_e8
    .catch Ljava/lang/RuntimeException; {:try_start_c1 .. :try_end_e8} :catch_e8
    ...
    throw v12
    :try_end_11a
    .catch Ljava/io/IOException; {:try_start_ef .. :try_end_11a} :catch_e8
    .catch Ljava/lang/RuntimeException; {:try_start_ef .. :try_end_11a} :catch_e8
    ...
    :try_end_13f
    .catch Lorg/json/JSONException; {:try_start_11a .. :try_end_13f} :catch_142
    .catch Ljava/io/IOException; {:try_start_11a .. :try_end_13f} :catch_e8
    .catch Ljava/lang/RuntimeException; {:try_start_11a .. :try_end_13f} :catch_e8
    ...
    :try_end_158
    .catch Ljava/io/IOException; {:try_start_143 .. :try_end_158} :catch_e8
    .catch Ljava/lang/RuntimeException; {:try_start_143 .. :try_end_158} :catch_e8
    ...
    :try_end_163
    .catch Landroid/system/ErrnoException; {:try_start_158 .. :try_end_163} :catch_1a4
    .catch Ljava/io/IOException; {:try_start_158 .. :try_end_163} :catch_e8
    .catch Ljava/lang/RuntimeException; {:try_start_158 .. :try_end_163} :catch_e8
    ...
    :try_end_16a
    .catch Ljava/io/IOException; {:try_start_163 .. :try_end_16a} :catch_e8
    .catch Ljava/lang/RuntimeException; {:try_start_163 .. :try_end_16a} :catch_e8
    ...
    throw v12
    :try_end_1ae
    .catch Ljava/io/IOException; {:try_start_1a5 .. :try_end_1ae} :catch_e8
    .catch Ljava/lang/RuntimeException; {:try_start_1a5 .. :try_end_1ae} :catch_e8
.end method
