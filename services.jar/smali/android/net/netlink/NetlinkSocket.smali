...
.method public static sendOneShotKernelMessage(I[B)V
    ...
    :try_end_e
    .catch Ljava/lang/Throwable; {:try_start_7 .. :try_end_e} :catch_117
    .catchall {:try_start_7 .. :try_end_e} :catchall_110
    ...
    throw v3
    :try_end_74
    .catch Ljava/lang/Throwable; {:try_start_10 .. :try_end_74} :catch_74
    .catchall {:try_start_10 .. :try_end_74} :catchall_d9
    ...
    :try_end_81
    .catch Ljava/lang/Throwable; {:try_start_7e .. :try_end_81} :catch_101
    .catch Ljava/io/InterruptedIOException; {:try_start_7e .. :try_end_81} :catch_84
    .catch Ljava/net/SocketException; {:try_start_7e .. :try_end_81} :catch_ea
    ...
    throw v4
    :try_end_84
    .catch Ljava/io/InterruptedIOException; {:try_start_83 .. :try_end_84} :catch_84
    .catch Ljava/net/SocketException; {:try_start_83 .. :try_end_84} :catch_ea
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/net/netlink/NetlinkMessage;->toString()Ljava/lang/String;
    :try_end_e0
    .catch Ljava/lang/Throwable; {:try_start_9c .. :try_end_e0} :catch_74
    .catchall {:try_start_9c .. :try_end_e0} :catchall_d9
    ...
    invoke-virtual {v2}, Landroid/net/netlink/NetlinkSocket;->close()V
    :try_end_e7
    .catch Ljava/lang/Throwable; {:try_start_e4 .. :try_end_e7} :catch_ff
    .catch Ljava/io/InterruptedIOException; {:try_start_e4 .. :try_end_e7} :catch_84
    .catch Ljava/net/SocketException; {:try_start_e4 .. :try_end_e7} :catch_ea
    ...
    throw v18
    :try_end_ea
    .catch Ljava/io/InterruptedIOException; {:try_start_e9 .. :try_end_ea} :catch_84
    .catch Ljava/net/SocketException; {:try_start_e9 .. :try_end_ea} :catch_ea
    ...
    throw v3
    :try_end_10f
    .catch Ljava/io/InterruptedIOException; {:try_start_109 .. :try_end_10f} :catch_84
    .catch Ljava/net/SocketException; {:try_start_109 .. :try_end_10f} :catch_ea
