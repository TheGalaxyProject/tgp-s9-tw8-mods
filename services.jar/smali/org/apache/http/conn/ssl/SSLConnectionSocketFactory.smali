...
.method private verifyHostname(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)V
    ...
    :try_end_41
    .catch Ljava/lang/Exception; {:try_start_3e .. :try_end_41} :catch_1a9
    ...
    invoke-interface {v14, v15}, Lorg/apache/commons/logging/Log;->debug(Ljava/lang/Object;)V
    :try_end_8a
    .catch Ljava/io/IOException; {:try_start_42 .. :try_end_8a} :catch_3d
    ...
    invoke-interface {v2, v14}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_16d
    .catch Ljava/lang/Exception; {:try_start_8a .. :try_end_16d} :catch_111
    .catch Ljava/io/IOException; {:try_start_8a .. :try_end_16d} :catch_3d
    ...
    throw v14
    :try_end_1a9
    .catch Ljava/io/IOException; {:try_start_16e .. :try_end_1a9} :catch_3d
...
.method public connectSocket(ILjava/net/Socket;Lorg/apache/http/HttpHost;Ljava/net/InetSocketAddress;Ljava/net/InetSocketAddress;Lorg/apache/http/protocol/HttpContext;)Ljava/net/Socket;
    ...
    :try_end_21
    .catch Ljava/io/IOException; {:try_start_16 .. :try_end_21} :catch_42
    ...
    :try_end_6b
    .catch Ljava/io/IOException; {:try_start_47 .. :try_end_6b} :catch_42
