...
.method private getUri(Ljava/lang/String;)Landroid/net/Uri;
    ...
    move-object v4, v0
    :try_end_38
    .catch Ljava/lang/ClassNotFoundException; {:try_start_1 .. :try_end_38} :catch_39
    .catch Ljava/lang/NoSuchMethodException; {:try_start_1 .. :try_end_38} :catch_39
    .catch Ljava/lang/IllegalAccessException; {:try_start_1 .. :try_end_38} :catch_39
    .catch Ljava/lang/IllegalArgumentException; {:try_start_1 .. :try_end_38} :catch_39
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_1 .. :try_end_38} :catch_39
...
.method public read(Landroid/content/ContentResolver;)V
    ...
    :try_end_91
    .catch Ljava/lang/ClassNotFoundException; {:try_start_0 .. :try_end_91} :catch_ef
    .catch Ljava/lang/NoSuchMethodException; {:try_start_0 .. :try_end_91} :catch_ef
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_91} :catch_ef
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_91} :catch_ef
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_91} :catch_ef
    ...
    :try_end_ee
    .catch Ljava/lang/ClassNotFoundException; {:try_start_c8 .. :try_end_ee} :catch_ef
    .catch Ljava/lang/NoSuchMethodException; {:try_start_c8 .. :try_end_ee} :catch_ef
    .catch Ljava/lang/IllegalAccessException; {:try_start_c8 .. :try_end_ee} :catch_ef
    .catch Ljava/lang/IllegalArgumentException; {:try_start_c8 .. :try_end_ee} :catch_ef
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_c8 .. :try_end_ee} :catch_ef
    ...
    const-class v3, Ljava/lang/String;
    :try_end_24c
    .catch Ljava/lang/ClassNotFoundException; {:try_start_fa .. :try_end_24c} :catch_ef
    .catch Ljava/lang/NoSuchMethodException; {:try_start_fa .. :try_end_24c} :catch_ef
    .catch Ljava/lang/IllegalAccessException; {:try_start_fa .. :try_end_24c} :catch_ef
    .catch Ljava/lang/IllegalArgumentException; {:try_start_fa .. :try_end_24c} :catch_ef
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_fa .. :try_end_24c} :catch_ef
