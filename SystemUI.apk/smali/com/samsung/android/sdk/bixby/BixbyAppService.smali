...
.method private checkSenderIdentity()Z
    ...
    :try_end_44
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_31 .. :try_end_44} :catch_48
...
.method private isKnoxId()Z
    ...
    :try_end_6d
    .catch Ljava/lang/ClassNotFoundException; {:try_start_1 .. :try_end_6d} :catch_6e
    .catch Ljava/lang/NoSuchMethodException; {:try_start_1 .. :try_end_6d} :catch_6e
    .catch Ljava/lang/SecurityException; {:try_start_1 .. :try_end_6d} :catch_6e
    .catch Ljava/lang/IllegalAccessException; {:try_start_1 .. :try_end_6d} :catch_6e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_1 .. :try_end_6d} :catch_6e
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_1 .. :try_end_6d} :catch_6e
    .catch Ljava/lang/NullPointerException; {:try_start_1 .. :try_end_6d} :catch_6e
    ...
    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_9a
    .catch Ljava/lang/ClassNotFoundException; {:try_start_81 .. :try_end_9a} :catch_6e
    .catch Ljava/lang/NoSuchMethodException; {:try_start_81 .. :try_end_9a} :catch_6e
    .catch Ljava/lang/SecurityException; {:try_start_81 .. :try_end_9a} :catch_6e
    .catch Ljava/lang/IllegalAccessException; {:try_start_81 .. :try_end_9a} :catch_6e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_81 .. :try_end_9a} :catch_6e
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_81 .. :try_end_9a} :catch_6e
    .catch Ljava/lang/NullPointerException; {:try_start_81 .. :try_end_9a} :catch_6e
...
.method private makeStateResultCommand(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_5c
    .catch Lorg/json/JSONException; {:try_start_7 .. :try_end_5c} :catch_67
